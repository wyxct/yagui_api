...
class Agv(db.Model):
    ...
    agv_type_id = db.Column(db.ForeignKey('agv_type.id'), nullable=False, info='the type of this AGV, foreign key of agv_type.id')
...
class AgvLocate(Agv):
    ...
    agv_id = db.Column(db.ForeignKey('agv.id'), primary_key=True, server_default=db.FetchedValue(), info='internal id for identifying a record')
...
class AgvMaintenance(Agv):
    ...
    agv_id = db.Column(db.ForeignKey('agv.id'), primary_key=True, info='foreign key of agv.id')
...
class AgvRealtimeDatum(Agv):
    ...
    agv_id = db.Column(db.ForeignKey('agv.id'), primary_key=True, info='foreign key of agv.id')
    current_agv_command_id = db.Column(db.ForeignKey('agv_command.id'), info='foreign key of agv_command.id, the command that the agv is currently executing')
    ...
    agv_customized_data_type_id = db.Column(db.ForeignKey('agv_customized_data_type.id'), info='foreigh key of agv_customized_data_type.id')
...
class AgvState(Agv):
    ...
    agv_id = db.Column(db.ForeignKey('agv.id'), primary_key=True, server_default=db.FetchedValue(), info='foreign key of agv.id')
    agv_management_status_id = db.Column(db.ForeignKey('agv_management_status.id'), nullable=False, server_default=db.FetchedValue(), info='foreign key of agv_management_status.id')
    ...
    blocked_by_agv_id = db.Column(db.ForeignKey('agv.id'), info='foreign key of agv.id, the AGV that blocks this AGV')
...
class AgvTaskDutyCycle(Agv):
    ...
    agv_id = db.Column(db.ForeignKey('agv.id'), primary_key=True, info='foreign key of agv_id')
...
class AgvTrafficConfig(Agv):
    ...
    agv_id = db.Column(db.ForeignKey('agv.id'), primary_key=True, info='internal id for identifying a record,FOREIGN KEY of agv.id')
    map_id = db.Column(db.ForeignKey('map.id'), info='map_id FOREIGN KEY of map.id')
...
class AgvCommand(db.Model):
    ...
    agv_command_type_id = db.Column(db.ForeignKey('agv_command_type.id'), nullable=False, index=True, info='foreign key of agv_command_type.id')
    agv_command_status_id = db.Column(db.ForeignKey('agv_command_status.id'), nullable=False, index=True, server_default=db.FetchedValue(), info='foreign key of agv_command_status.id')
    ...
    agv_id = db.Column(db.ForeignKey('agv.id'), index=True, info='foreign key of agv.id')
...
class AgvError(db.Model):
    ...
    id = db.Column(db.BigInteger, primary_key=True, server_default=db.FetchedValue(), info='the internal id to identify a record')
    agv_id = db.Column(db.ForeignKey('agv.id'), info='foreign key of agv.id')
    agv_error_type_id = db.Column(db.ForeignKey('agv_error_type.id'), info='foreign key of agv_error_type.id')
...
class AgvErrorSolutionRelation(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True, server_default=db.FetchedValue())
    agv_error_type_id = db.Column(db.ForeignKey('agv_error_type.id'))
    agv_error_solution_id = db.Column(db.ForeignKey('agv_error_solution.id'))
    created_user = db.Column(db.String(200))
    created_timestamp = db.Column(db.DateTime(True), server_default=db.FetchedValue())
    last_updated_user = db.Column(db.String(200))
    last_updated_timestamp = db.Column(db.DateTime(True), server_default=db.FetchedValue())
...
class AgvErrorType(db.Model):
    ...
    error_catagory_id = db.Column(db.ForeignKey('agv_error_catagory.id'), info='the error type catagory')
    agv_type_id = db.Column(db.ForeignKey('agv_type.id'), info='the type of agv')
...
class AgvType(db.Model):
    ...
    last_updated_user = db.Column(db.String(200), info='the user name that updated this record most recently.')
    last_updated_timestamp = db.Column(db.DateTime(True), server_default=db.FetchedValue(), info='the timestamp when updated this record most recently')
    agv_use_type_id = db.Column(db.ForeignKey('agv_use_type.id'), info='FK to the agv_use_type.id; agv_use_type represents the type from user view regardless of the uderlying small difference.')
...
class AgvUseType(db.Model):
    ...
    last_updated_user = db.Column(db.String(200), info='the user name that updated this record most recently.')
    last_updated_timestamp = db.Column(db.DateTime(True), server_default=db.FetchedValue(), info='the timestamp when updated this record most recently')
    agv_use_type_category_id = db.Column(db.ForeignKey('agv_use_type_category.id'))
...
class DeviceIoRelation(db.Model):
    ...
    io_id = db.Column(db.ForeignKey('io.id'), nullable=False, index=True)
    io_value = db.Column(db.ForeignKey('io_status_type.id'), nullable=False, index=True)
    device_iddress = db.Column(db.String(200))
    device_value = db.Column(db.Integer)
    write_io_id = db.Column(db.ForeignKey('io.id'), index=True)
    write_io_value = db.Column(db.ForeignKey('io_status_type.id'), index=True)
    created_user = db.Column(db.String(200))
    created_timestamp = db.Column(db.DateTime(True), server_default=db.FetchedValue())
    last_updated_user = db.Column(db.String(200))
    last_updated_timestamp = db.Column(db.DateTime(True), server_default=db.FetchedValue())
...
class Io(db.Model):
    ...
    io_type_id = db.Column(db.ForeignKey('io_type.id'), info='internal id for identifying a record')
    description = db.Column(db.String(2000), info='the detailed description and definition of this io type')
    created_user = db.Column(db.String(200), info='the user name that created this record')
    created_timestamp = db.Column(db.DateTime(True), server_default=db.FetchedValue(), info='the user name that updated this record most recently.')
    last_updated_user = db.Column(db.String(200), info='the user name that updated this record most recently.')
    last_updated_timestamp = db.Column(db.DateTime(True), server_default=db.FetchedValue(), info='the timestamp when updated this record most recently')
    device_id = db.Column(db.ForeignKey('device_config.id'))
...
class IoState(Io):
    ...
    io_id = db.Column(db.ForeignKey('io.id'), primary_key=True, server_default=db.FetchedValue(), info='fk io.id ')
    io_status_id = db.Column(db.ForeignKey('io_status_type.id'), info='the status of this io')
...
class IoCommand(db.Model):
    ...
    io_command_type_id = db.Column(db.ForeignKey('io_command_type.id'), info='the name of this io type, should be brief and clear')
    io_id = db.Column(db.Integer, info='to classify the io type')
    io_status_id = db.Column(db.ForeignKey('io_status_type.id'), info='to classify the io type')
...
class IoCommandExecutionDatum(IoCommand):
    ...
    io_command_id = db.Column(db.ForeignKey('io_command.id'), primary_key=True, server_default=db.FetchedValue(), info='the name of this io type, should be brief and clear')
    io_command_status_id = db.Column(db.ForeignKey('io_command_status.id'), info='to classify the io type')
...
class MapAgvOverride(db.Model):
    ...
    map_edge_id = db.Column(db.ForeignKey('map_edge.id'), index=True, info='edge id, FOREIGN KEY of map_edge.id')
...
class MapCommand(db.Model):
    ...
    agv_id = db.Column(db.ForeignKey('agv.id'), index=True, info='agv_id,FOREIGN KEY of agv.id')
    map_edge_id = db.Column(db.ForeignKey('map_edge.id'), index=True, info='map_edge_id FOREIGN KEY of map_edge.id')
...
class MapDock(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True, server_default=db.FetchedValue(), info='internal id for identifying a record')
    map_id = db.Column(db.ForeignKey('map.id'), index=True)
...
class MapEdge(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True, server_default=db.FetchedValue(), info='internal id for identifying a record')
    map_id = db.Column(db.ForeignKey('map.id'), index=True, info='the map id of this edge related to')
...
class MapEdgeRelation(db.Model):
    ...
    id = db.Column(db.BigInteger, primary_key=True, server_default=db.FetchedValue(), info=' the internal id to identify a record ')
    from_map_edge_id = db.Column(db.ForeignKey('map_edge.id'))
    destination_map_edge_id = db.Column(db.ForeignKey('map_edge.id'), info=' object id')
...
class MapNode(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True, server_default=db.FetchedValue(), info='internal id for identifying a record')
    map_id = db.Column(db.ForeignKey('map.id'), index=True, info='the map id of this node related to')
